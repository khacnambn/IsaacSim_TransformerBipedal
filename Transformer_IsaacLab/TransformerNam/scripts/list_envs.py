...
All the environments are registered in the `TransformerNam` extension. They start
...
import TransformerNam.tasks  # noqa: F401


def main():
    """Print all environments registered in `TransformerNam` extension."""
